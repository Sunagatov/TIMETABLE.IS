...
- `.project/docs/requirements/` — product requirements and V1 behavior contracts.
- `.project/docs/ai/` — canonical detailed AI-agent knowledge base.
- `.project/docs/ai/current-state.md` — current implementation reality.
- `.project/docs/ai/api-surface.md` — endpoint contracts, query params, sort, state guards.
- `.project/docs/ai/invariants.md` — durable behavior rules.
- `.project/docs/ai/request-routing-guide.md` — choose minimal context for each task.
- `.project/docs/ai/token-budget-rules.md` — reading discipline and archive/stale-doc rules.
- `.project/docs/ai/frontend-v1-mvp.md` — detailed frontend auth/review/filter/category/item-detail/testing guide.
