...
- for local bootstrap, env-loading, cookie, or transcription model questions, read `.project/docs/ai/env-runtime-reference.md` before source scanning
...
- prefer Vault docs/tasks first when the problem is really local orchestration, production env, SSH tunnel, or Whisper server behavior
